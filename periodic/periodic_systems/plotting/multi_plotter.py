...
df3 = pd.read_csv('data_multiplots/results_right_3ul.txt')
df4 = pd.read_csv('data_multiplots/results_right.txt')
...
ax2 = plt.subplot2grid((1, 8), (0, 3), colspan=1)
...
ax3 = plt.subplot2grid((1, 8), (0, 4), colspan=1)
ax3.tick_params(labelleft=False)
ax3.plot(df3, c='black')
# plt.xlabel('k')
plt.xticks(np.arange(hs_df, df_size, (df_size-3)/2), ('0', 'π/3a'), size='8', ha='right')

ax4 = plt.subplot2grid((1, 8), (0, 5), colspan=3)
